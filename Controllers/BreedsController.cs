...
namespace Vet_Surgery_System.Controllers
{
    public class BreedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "B_Id,Specie_Name,Breed1,Date_Time")] Breed breed)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "B_Id,Specie_Name,Breed1,Date_Time")] Breed breed)
        {
            if (ModelState.IsValid)
            {
